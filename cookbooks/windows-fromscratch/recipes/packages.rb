...
# install Notepad++ (Y U No Emacs?)
windows_package "Notepad++" do
  source "http://download.tuxfamily.org/notepadplus/6.2.2/npp.6.2.2.Installer.exe"
  action :install
end
...
# Tableau Public
windows_package "Tableau Public" do
  source "http://downloadscdn.tableausoftware.com/public/TableauPublicDesktop.msi"
  action :install
end unless true
